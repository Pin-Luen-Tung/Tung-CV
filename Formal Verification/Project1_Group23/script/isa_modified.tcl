...
# include source code
analyze -sv [glob ../source/modified/RV12/submodules/ahb3lite_pkg/rtl/verilog/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/pkg/riscv_state_pkg.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/pkg/*.sv]
analyze -sv [glob ../source/modified/RV12/submodules/memory/rtl/verilog/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/core/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/core/ex/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/core/cache/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/core/mmu/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/core/memory/*.sv]
analyze -sv [glob ../source/modified/RV12/rtl/verilog/ahb3lite/*.sv]
