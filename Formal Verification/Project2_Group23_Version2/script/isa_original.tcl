...
# include source code
analyze -v2k [glob ../source/original/biriscv/biriscv/icache/*.v]
analyze -v2k [glob ../source/original/biriscv/biriscv/dcache/*.v]
analyze -v2k [glob ../source/original/biriscv/biriscv/core/*.v]
analyze -v2k [glob ../source/original/biriscv/biriscv/top/riscv_top.v]
